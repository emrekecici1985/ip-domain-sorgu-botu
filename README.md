...
Termux üzerinde herhangi bir harici eklenti (`pip`, `python`, `node` vb.) yüklemeye gerek kalmadan, tamamen terminalin kendi gücüyle çalışan pratik bir IP ve Alan adı bilgi sorgulama (OSINT) aracılığıdır. İçi bomboş, yeni kurulmuş bir Termux'ta bile anında çalışır.
